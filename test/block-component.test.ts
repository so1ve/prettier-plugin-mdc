...
describe("block-component", () => {
  runTests({
    ...
    "component-attributes-length-80": `::component{a="${Array.from({ length: 80 - 17 + 1 }).join("a")}"}\n::`,
    "component-attributes-length-81": `::component{a="${Array.from({ length: 81 - 17 + 1 }).join("a")}"}\n::`,
    "frontmatter":
      "::with-frontmatter\n---\nkey: value\narray:\n  - item\n  - itemKey: value\n---\n::",
